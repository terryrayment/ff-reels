        ...
        {spots.map((spot) => {
          ...
          return (
            <button
              ...
              className="group/spot grid min-w-0 grid-cols-[minmax(8.5rem,1fr)_auto] items-center gap-3 border-t border-white/18 py-3 text-left text-white transition hover:border-white/42 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white sm:grid-cols-[minmax(9.75rem,1fr)_auto]"
              aria-label={`Open ${spot.title}`}
            >
              <div className="relative aspect-video min-w-0 overflow-hidden rounded-[4px] bg-white/8">
                ...
                <img
                  ...
                  loading="lazy"
                />
                <span className="absolute bottom-2 left-2 right-2 text-[12px] font-semibold leading-none tracking-[-0.01em] text-white">
                  {label}
                </span>
              </div>
